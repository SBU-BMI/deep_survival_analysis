...
if __name__ == '__main__':
    ...
    parser.add_argument('--valid-root', type=str, required=True, help='directory to valid data path')
    ...
    parser.add_argument('--concate-valid-root', type=str, default='', help='directory to valid data path to concate feature')
    ...
    valid_wsi_id_list, valid_Feat, pca_model, _ = load_feat(valid_root, fn, concate_valid_root, concate_fn, pca_model, concate_pca_model, mode='test')
    ...
    if global_pca_model is not None:
        ...
        valid_Feat = globa_pca_model.transform(valid_Feat)
