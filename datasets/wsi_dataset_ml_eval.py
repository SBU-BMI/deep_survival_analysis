...
class Patch_Data_Eval(data.Dataset):
    def __init__(self, wsi_root, nu_seg_root, tumor_pred_root, til_pred_root,
                 ...
                 n_patches=16, n_patches_wsi=1024, interval=750, n_intervals=5, 
        ...
        self.n_patches_wsi = n_patches_wsi
        self.interval = interval
        self.n_intervals = n_intervals
        self.n_repetitions = n_patches_wsi // n_patches
    ...
    def __len__(self):
        ...
        return len(self.wsi_id_no) * self.n_repetitions
    ...
    def _load_cat_data0(self, wsi_id, txy, pxy):
        subfn = '/{}_{}_{}_{}'.format(txy[0], txy[1], self.tile_size[0], self.tile_size[1])
    ...
    def __getitem__(self, index_):
        no = self.nos[index_ // self.n_repetitions]
        ...
        return imgs, y, obs, wsi_id, labels
